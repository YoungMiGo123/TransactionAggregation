...
public class TransactionsController : BaseController
{
    ...
    public TransactionsController(IMessageBus messageBus)
    {
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionsResponse>>(new GetAllTransactionsQuery());
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionsResponse>>(new GetTransactionsByCustomerQuery(customerId));
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionsResponse>>(new GetTransactionsByCategoryQuery(category));
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionsResponse>>(new GetTransactionsByDateRangeQuery(startDate, endDate));
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionsResponse>>(new GetTransactionsBySourceQuery(source));
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<TransactionSummary>>(new GetCustomerSummaryQuery(customerId));
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<CategorySummaryResponse>>(new GetCategorySummaryQuery());
    ...
    {
        var response = await _messageBus.InvokeAsync<ApiResponse<SourceSummaryResponse>>(new GetSourceSummaryQuery());
